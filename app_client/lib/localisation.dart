...
//  double Haedheight = 55;
 ...
 // }
  ...
  static  LatLng  _center = const LatLng(3.8408866,11.488843);// LatLng(double.parse(_station.localisation.latitude), double.parse(_station.localisation.longitude) );
