   ...
   List<Step> stepList() => [
        Step(
          ...
          content:   SingleChildScrollView(
           ...
           SizedBox(height:16),
          textFiel("Description du colis","description",false,descriptionControl,false),
            SizedBox(height:16),
           textFiel("Selectionner","poids",true,poidsControl,false),
           SizedBox(height:16),
               textFiel("photos","selectionner une photo du colis",false,photoControl,true),
               SizedBox(height:16),
            textFiel("selectionner","encombrement",true,encombrementControl,false),
            SizedBox(height:16),
             textFiel("Selectionner","paiement",true,paiementControl,false),
                 SizedBox(height:16),
              ],
            ),
          ),
        ...
        Step(
            ...
            content: SingleChildScrollView(
              child: Column(
                children: [
                   SizedBox(height:16),
                  textFiel("selectionner","region",true,regionControl,false),
                   SizedBox(height:16),
                   textFiel("selectionner","ville",true,villeControl,false),
                    SizedBox(height:16),
           textFiel("Entrer le lieu de  depart du coli","Lieu de depart",false,lieuDepControl,false),
            SizedBox(height:16),
            textFiel("Entrer le lieu d'arrivé du coli","Lieu d'arrivé",false,lieuArrControl,false),
             SizedBox(height:16),
          textFiel("Entrer le nom du recepteur du colis","Nom du destinataire",false,nomDesControl,false),
           SizedBox(height:16),
        textFiel("Entrer le contact du recepteur","contact",false,contactControl,false),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     body: Center(
        ...
        const SnackBar(content: Text('données en cours de traitement')),);
                    Navigator.push(
                      context,
...
Widget textFiel(String hintText, String label, bool select ,TextEditingController control, bool photo ){
  String controller;
  var items = ['Working a lot harder', 'Being a lot smarter', 'Being a self-starter', 'Placed in charge of trading charter'];
       ...
       return TextFormField(
         ...
         decoration: InputDecoration(
           ...
           suffixIcon: select ? PopupMenuButton<String>(
